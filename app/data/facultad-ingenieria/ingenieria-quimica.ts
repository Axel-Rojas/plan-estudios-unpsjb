...
const ingenieriaQuimica: Carrera = {
    ...
    materias: [
        ...
        // 2° Año - Anual
        { codigo: "QU002", nombre: "Química Orgánica Aplicada", año: 2, cuatrimestre: 0, correlativas: ["QU001"], cargaHoraria: 150 },

        // 3° Año - 1° Cuatrimestre
        { codigo: "QU004", nombre: "Química Analítica", año: 3, cuatrimestre: 1, correlativas: ["MA006", "QU002"], cargaHoraria: 90 },
        ...
        // 3° Año - Anual
        { codigo: "ES012", nombre: "Mecánica", año: 3, cuatrimestre: 0, correlativas: ["FI001"], cargaHoraria: 90 },
        { codigo: "ES009", nombre: "Tecnología de los Materiales", año: 3, cuatrimestre: 0, correlativas: ["FI002", "QU003"], cargaHoraria: 90 },
        { codigo: "QU005", nombre: "Fisicoquímica", año: 3, cuatrimestre: 0, correlativas: ["MA003", "QU003"], cargaHoraria: 150 },
        ...
        // 4° Año - Anual
        { codigo: "QU008", nombre: "Operaciones Físicas I", año: 4, cuatrimestre: 0, correlativas: ["MA007", "FA004", "ES012", "QU006"], cargaHoraria: 150 },
        { codigo: "QU009", nombre: "Operaciones Físicas II", año: 4, cuatrimestre: 0, correlativas: ["MA007", "FA004", "ES012", "QU006"], cargaHoraria: 150 },
        { codigo: "QU010", nombre: "Operaciones Físicas III", año: 4, cuatrimestre: 0, correlativas: ["MA007", "FA004", "ES012", "QU005", "QU006"], cargaHoraria: 150 },
        ...
        { codigo: "FA003", nombre: "Ingeniería Legal", año: 4, cuatrimestre: 0, correlativas: [], condicion: "14 asignaturas aprobadas", cargaHoraria: 75 },

        // 5° Año - 1° Cuatrimestre
        { codigo: "QU016", nombre: "Simulación de Procesos", año: 5, cuatrimestre: 1, correlativas: ["QU008", "QU009", "QU010"], cargaHoraria: 75 },
        { codigo: "QU_OP1", nombre: "Optativa I", año: 5, cuatrimestre: 1, correlativas: [], cargaHoraria: 60, esOptativa: true, grupoOptativa: "optativa1" },
        // 5° Año - 2° Cuatrimestre
        { codigo: "QU013", nombre: "Optimización", año: 5, cuatrimestre: 2, correlativas: ["QU008", "QU009", "QU010"], cargaHoraria: 75 },
        { codigo: "QU_OP2", nombre: "Optativa II", año: 5, cuatrimestre: 2, correlativas: [], cargaHoraria: 60, esOptativa: true, grupoOptativa: "optativa1" },
        // 5° Año - Anual
        { codigo: "QU012", nombre: "Instrumentación y Control", año: 5, cuatrimestre: 0, correlativas: ["MA042", "QU008", "QU009", "QU010"], cargaHoraria: 150 },
        { codigo: "QU014", nombre: "Procesos Unitarios", año: 5, cuatrimestre: 0, correlativas: ["MA007", "QU004", "QU005", "QU006"], cargaHoraria: 150 },
        { codigo: "QU015", nombre: "Proyecto de Ingeniería Química", año: 5, cuatrimestre: 0, correlativas: ["QU007", "QU008", "QU009", "QU010", "QU011", "FA002"], cargaHoraria: 150 },
        ...
        { codigo: "FA024", nombre: "Gestión Empresarial", año: 5, cuatrimestre: 1, correlativas: [], condicion: "17 asignaturas aprobadas", cargaHoraria: 45, esOptativa: true, grupoOptativa: "optativa1" },
        ...
        { codigo: "II012", nombre: "Principios de Calidad Total", año: 5, cuatrimestre: 1, correlativas: [], condicion: "17 asignaturas aprobadas", cargaHoraria: 45, esOptativa: true, grupoOptativa: "optativa1" },
        ...
        { codigo: "QU019", nombre: "Tratamiento de Efluentes Líquidos", año: 5, cuatrimestre: 1, correlativas: [], condicion: "17 asignaturas aprobadas", cargaHoraria: 45, esOptativa: true, grupoOptativa: "optativa1" },
    ...
    requisitos: [
        ...
        { codigo: "QU020", nombre: "Práctica Profesional Supervisada IQ", condicion: "24 asignaturas aprobadas" },
